/**
 * @fileoverview A menu to provide a list of actions or options to a user.
 * This component is built on top of Radix UI's Dropdown Menu primitive for accessibility and functionality.
