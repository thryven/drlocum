...
const DialogOverlay = forwardRef<ElementRef<typeof Overlay>, ComponentPropsWithoutRef<typeof Overlay>>(
  ({ className, ...props }, ref) => (
    <Overlay
      ref={ref}
      className={cn(
        'fixed inset-0 z-50 bg-black/50 backdrop-blur-xs data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=open]:duration-200 data-[state=closed]:duration-200 ease-out',
        className,
      )}
      {...props}
    />
  ...
  ({ className, children, ...props }, ref) => (
    <DialogPortal>
      ...
      <Content
        ref={ref}
        className={cn(
          'fixed left-[50%] top-[50%] z-50 grid w-[90vw] max-w-[500px] translate-x-[-50%] translate-y-[-50%] gap-4 border bg-card rounded-modal shadow-2xl p-8 duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 ease-out',
          className,
        )}
        {...props}
      >
