/**
 * @fileoverview A vertically stackable set of interactive headings that each reveal a section of content.
 * This component is built on top of Radix UI's Accordion primitive for accessibility and functionality.
