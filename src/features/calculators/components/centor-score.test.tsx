// src/features/calculators/components/centor-score.test.tsx

import { act, render, screen } from '@testing-library/react'
import userEvent from '@testing-library/user-event'
import { describe, expect, it } from 'vitest'
import CentorScoreCalculator from './centor-score'
...
describe('CentorScoreCalculator', () => {
  it('renders the initial form correctly and hides result', () => {
    render(<CentorScoreCalculator />)
