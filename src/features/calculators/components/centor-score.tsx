// src/features/calculators/components/centor-score.tsx
'use client'
...
import { useCentorScore } from '@/features/calculators/hooks/use-centor-score'
import type { AgeGroup, Criteria } from '@/features/calculators/lib/centor-score'
import { criteria } from '@/features/calculators/lib/centor-score'
 ...
 */
export default function CentorScoreCalculator() {
