...
import type { PregnancyInfo } from '@/features/calculators/lib/pregnancy-calculator'
 ...
 *
 * @param pregnancyInfo - Pregnancy calculation results used to populate the estimated due date, EDD source and discrepancy, gestational age, conception date, trimester milestone dates, and a list of screening window entries.
