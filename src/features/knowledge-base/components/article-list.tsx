// src/features/knowledge-base/components/article-list.tsx
import { format } from 'date-fns'
import Link from 'next/link'
import { Badge } from '@/components/ui/badge'
import { Card, CardDescription, CardHeader, CardTitle } from '@/components/ui/card'
import { type Article, getPublishedArticles } from '@/features/knowledge-base/lib/notion'
  ...
  return (
    <div className='w-full max-w-4xl mx-auto pb-24'>
      <header className='mb-8 text-center'>
        ...
        <p className='text-muted-foreground mt-2'>Curated medical articles and clinical resources.</p>
      </header>
