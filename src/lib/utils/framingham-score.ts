...
const getRiskPercent = (gender: Gender, points: number): string => {
  if (gender === 'male') {
    ...
    if (points === -2) return '1.1'
    if (points === -1) return '1.4'
    if (points === 0) return '1.6'
    if (points === 1) return '1.9'
    if (points === 2) return '2.3'
    if (points === 3) return '2.8'
    if (points === 4) return '3.3'
    if (points === 5) return '3.9'
    if (points === 6) return '4.7'
    if (points === 7) return '5.6'
    if (points === 8) return '6.7'
    if (points === 9) return '7.9'
    if (points === 10) return '9.4'
    if (points === 11) return '11.2'
    if (points === 12) return '13.2'
    if (points === 13) return '15.6'
